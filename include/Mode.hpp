...
class Mode
{
    ...
    private:
        ...
        Mode::Phase UpdateFreefall(Navigation& navigation, Controller& controller, Igniter& igniter, double currTime, int i);
        Mode::Phase UpdateSafeMode(Navigation& navigation, Controller& controller);
        Mode::Phase UpdateLand(Navigation& navigation, Controller& controller,double current_time, int i);
