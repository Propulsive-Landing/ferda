...
namespace MissionConstants
{
    ...
    const double kNavCameraAssociationUnassignedPenaltyRad = 0.15;
    const int kNavCameraRecoveryMinDetectedMarkers = 4;
    const double kNavCameraRecoveryMaxAverageAngularErrorRad = 0.1;
    ...
    inline const Eigen::Matrix<double, 3, 4> kMarkerData =
        (Eigen::Matrix<double, 3, 4>() << -0.2575 - 1.117, 0.2575 - 1.117, -0.2575 - 1.117, 0.2575 - 1.117,
    ...
    const int kSensorCameraMaxDetections = 8;
