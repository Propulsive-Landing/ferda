...
void ValveControl::OpenValve(ValveType valve)
{
    ...
    case Nitrogen:
        ...
        // NOTE: We do not handle if servo_driver is a null pointer meaning the PCA9685 is not connected because we assume it is connected and if not we want to crash immedietely
